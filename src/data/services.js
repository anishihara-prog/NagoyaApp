export const SERVICES = [
  ...
  {
    id: 5, title: 'トワイライトスクール・学童保育', cat: 'child', urgent: false, target: 'child', grayzone: false,
  ...
  },
  {
    ...
    url: 'https://www.city.nagoya.jp/kenkofukushi/fukushi/1016735/1016739.html', contact: '名駅：052-446-7333 ／金山：052-684-8131 ／大曽根：052-508-9611',
    hours: '月〜金（祝日・年末年始を除く）及び第2、3土 / 9:00〜17:00（火は20:00）',
  ...
  },
  {
    ...
    hours: '営業時間:8:45〜17:15（毎週木は19:00営業）（ご相談等の場合は、終了30分前においでください） / 営業時間:10:00〜19:00（ご相談等の場合は、終了30分前においでください）',
  ...
  },
  {
    ...
    hours: 'サービス提供時間：月〜金の9:30〜12:00、13:00〜17:00（祝日、夏季休暇、年末年始を除く。） / 月〜金・第2土（祝日、夏季休暇、年末年始を除く、第2土が祝日の場合は第3土開館）',
  ...
  },
  {
    ...
    hours: '電話相談時間：毎日（祝・年末年始除く）9:00〜22:00 / LINE相談受付時間：16:00〜21:10',
  ...
  },
  {
    ...
    url: 'https://www.city.nagoya.jp/kodomo/kosodate/1009013/1034073/1009017.html', contact: '各区役所 民生子ども課（052-972-3083）',
    hours: '8:00〜18:00',
  ...
  },
  {
    ...
    url: 'https://www.city.nagoya.jp/kodomo/wakamono/1034350/1015845.html', contact: '女性相談支援センター 052-351-5388',
    hours: '月〜金(祝日・年末年始を除く) 10:00〜17:00 / 土・日・祝日(年末年始を除く) 10:00〜18:00',
  ...
  },
  {
    ...
    hours: '相談時間：月・水・金の10:00〜13:00（祝日・年末年始12月29日〜1月3日を除く） / 24時間・年中無休',
  ...
  },
  {
    ...
    welnet: false,
    cond: (s) => s.disabledMembers?.includes('hikikomori') || s.concerns?.includes('hikikomori_concern') || s.employment === 'unemployed' || s.concerns?.includes('work'),
  ...
  },
  {
    ...
    contact: 'なごや若者サポートステーション まえジョブ担当 052-700-2396',
    welnet: false,
    cond: (s) => (parseInt(s.age) >= 15 && parseInt(s.age) <= 49 && (s.employment === 'unemployed' || s.concerns?.includes('work'))) || s.disabledMembers?.includes('hikikomori'),
  ...
  {
    id: 137, title: '老齢基礎年金', cat: 'elderly', urgent: false, target: 'adult', grayzone: false,
  ...
  },
  {
    ...
    welnet: false,
    cond: (s) => s.children?.some(c => c.status === 'special') || s.concerns?.includes('child_disability'),
  },
  {
    id: 142, title: '民間オンライン学習プログラムによる学習支援', cat: 'child', urgent: false, target: 'child', grayzone: true,
    desc: '年間30日以上欠席する不登校の児童生徒向けに、学習指導要領準拠のオンライン教材「すらら」を無償提供。',
    detail: '【対象年齢】子ども18歳以下\n【対象】市立小・中学校に在籍し、登校しない・できない状況で年間30日以上欠席（見込みを含む）の児童生徒\n【内容】オンライン教材「すらら」（小学1年〜中学3年の全学年から自由に選択、解説動画・ドリル問題等）\n【費用】通信費は各家庭負担\n【申請先】在籍する小・中学校に申し出',
  ...
  {
    id: 150, title: '福祉給付金支給制度', cat: 'elderly', urgent: false, target: 'adult', grayzone: true,
  ...
  },
  {
    ...
    detail: '【対象】市内在住・在勤・在学の女性（家族等からの相談も可）\n【内容】仕事や子育てなど女性特有の健康課題全般について、保健・医療の専門職が助言\n【相談方法】電話：水曜19:00〜23:00・日曜14:00〜17:00（年末年始を除く）／LINE：24時間受付／メール：nagoyell@medi-staffsup.com（回答は原則平日9:00〜18:00）',
  ...
  {
    id: 157, title: '上・下水道料金の減免', cat: 'elderly', urgent: false, target: 'adult', grayzone: false,
