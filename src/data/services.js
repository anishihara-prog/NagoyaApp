export const SERVICES = [
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.children.some(c => (c.age||c) === 0),
    extraLinks: [{ url: 'https://www.city.nagoya.jp/kodomo/kosodate/1009320/1009332/1009333.html', label: '区役所民生子ども課一覧' }],
  },
  {
  ...
  },
  {
    ...
    welnet: false, cond: (s) => parseInt(s.age) >= 65 || s.elderlyMembers?.some(e => ['c1','c2','c3','c4','c5','s1','s2'].includes(e.careLevel)),
  ...
  },
  {
    ...
    welnet: false, cond: (s) => (parseInt(s.age) >= 65 && s.concerns?.includes('nursing')) || s.elderlyMembers?.some(e => ['c3','c4','c5'].includes(e.careLevel)),
  },
  {
    ...
    welnet: false, cond: (s) => (parseInt(s.age) >= 65 || s.elderlyMembers?.length > 0) && (s.income === 'low' || s.income === 'nontax'),
  },
  {
  ...
  },
  {
    ...
    welnet: false, cond: (s) => parseInt(s.age) >= 65 || s.elderlyMembers?.length > 0 || s.disabledMembers?.includes('disabled'),
  },
  {
    ...
    welnet: false, cond: (s) => (parseInt(s.age) >= 65 || s.elderlyMembers?.length > 0) && s.living === 'alone',
  },
  {
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.concerns?.includes('tax') || s.employment === 'unemployed' || s.sit?.includes('lowincome'),
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.concerns?.includes('waste'),
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.concerns?.includes('transport') || s.disabledMembers?.length > 0,
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.concerns?.includes('transport') || parseInt(s.age) >= 65 || s.elderlyMembers?.length > 0,
  },
  {
  ...
  },
  {
    ...
    welnet: false, cond: (s) => s.employment === 'parental' || s.sit?.includes('pregnant') || s.concerns?.includes('pregnant') || s.children?.some(c => (c.age||c) <= 1),
  },
  {
    ...
    welnet: false, cond: (s) => s.concerns?.includes('nursing') || parseInt(s.age) >= 65 || s.elderlyMembers?.length > 0,
  },
  {
