...
const JP_OVERRIDES = {
  ...
  26: {
    jp: '【障害等のある方】で「精神障害（手帳あり）」\r\nまたは「未診断で障害の疑いあり」または 【障害福祉サービスの困りごとがある】または「グレーゾーンの方がいる」',
    note: 'プロフィールのボタン表記変更「発達障害の疑い（診断なし）」→「未診断で障害の疑いあり」に伴い和訳を更新',
  },
  27: {
    jp: '【障害等のある方】で「身体障害（手帳あり）」「知的障害（療育手帳）」「精神障害（手帳あり）」「未診断で障害の疑いあり」または 【障害福祉サービスの困りごとがある】または「グレーゾーンの方がいる」',
    note: 'プロフィールのボタン表記変更「発達障害の疑い（診断なし）」→「未診断で障害の疑いあり」に伴い和訳を更新',
  },
  28: {
    jp: '「精神障害（手帳あり）」または 「未診断で障害の疑いあり」または 【心の健康・メンタルの困りごとがある】または「グレーゾーンの方がいる」',
    note: 'プロフィールのボタン表記変更「発達障害の疑い（診断なし）」→「未診断で障害の疑いあり」に伴い和訳を更新',
  },
  24: {
